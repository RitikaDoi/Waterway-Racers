class Form
{
    ...
    display()
    {
        ...
        this.rules.html("RULES:- It is a multiplayer game so only 3 players can play this game at a time. You can go forward, left and right by using arrow keys but can't go backward. If your boat will touch any stone then you will be out of the game. If it touches tube then your Killed% will be increased by 10 and if Killed% will be equals to 50 then also you will be out of the game. There will be Speed Boosters(as arrows), if you will touch them then you can go further than other players. The racer who will reach the end 1st will win this game :)");
